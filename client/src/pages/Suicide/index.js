      ...
      <div className="LifePageContainer">
        <div className="MoodPage">
          ...
          <div className="SuicideBody">
            ...
            <p className="moodTextp1">
              ...
              U.S. alone, we have the ability to save nearly 45,000 lives every
              year. Globally, that number is closer to 800,000. But, hold up.
              Before we get to saving the world, let’s check-in. If you’re
              feeling like ending your life, you can always ask for help
              managing your emotions. Asking for help is brave. You are brave.
              You are valuable! You are important! And, the world needs you.
              Please share your gifts with the world, little bee.
            </p>
          </div>
          ...
          <div className="moodTextDiv2">
            ...
            <ul className="Moodul">
              ...
              <li className="Moodli">
                ...
                so many people in this world who not only want you in it, but
              ...
              <li className="Moodli">
                Confiding in someone can help you build a support system for
                times when you are feeling in a really dark place. Nervous about
                reaching out? Start with a text message like this: “Hey there.
                I’m feeling really alone right now. Would you mind keeping me
                company?”
              </li>
              <li className="Moodli">
              ...
              <li className="Moodli">
                Something that has helped me tremendously is putting my hands
                over my heart and simply being with the pain that I feel.
                Something amazing will happen when you trust that feeling is
                healing.
              </li>
              <li className="Moodli">
        ...
        <div className="infoCardsCard2">
          <div className="infoCardsFront2">
            What if I'm not worthy of life, love, abundance, freedom, or
            success?
          </div>
          <div className="infoCardsBack2">
            How ironic! Only that which is worthy can question its own
            worthiness. You are worthy just because you exist. There's nothing
            you need to do or be to prove yourself. You are worthy beyond belief
            simply because you're here - being. How cool is that!?
          </div>
        </div>
          ...
          <div className="MoodSec3container MoodPage">
            <div className="moodBox">
              <p className="moodTextbox">
                ...
                <br></br>
                UK: text 85258 | Ireland: text 086 1800 280 <br></br>
                Let us locate support nearby by providing your zipcode above.
              </p>
            </div>
            <div className="moodBox">
              <p className="moodTextbox">
                Text to talk -- Completely Confidential
                <span className="crisisHotline">
                  Text HOME to 741741: US & CANADA
                </span>
                <span className="moodTextbox">
                  Your life is worth living. This may be difficult to believe
                  right now. I invite you to place both hands over your heart
                ...
                <a
                  ...
                  href="https://www.youtube.com/watch?v=e71exrhEBQc&t=2s"
                >
                  ::curious::
                </a>
              </p>
            ...
            <div className="infoCardsCard3">
              ...
              <div className="infoCardsBack3">
                ...
                energy and frequency. Go play, little bee, and co-create with
                the humans.
              </div>
            </div>
