          ...
          <div className="moodTextDiv2">
            ...
            <ul className="Moodul">
              ...
              <li className="Moodli">
                ...
                often associated with fewer hours of daylight in the far
              ...
              Premenstrual dysphoric disorder — mood changes and irritability
                that occur during the premenstrual phase of a woman's cycle and
                go away with the onset of menses Persistent depressive disorder
                (dysthymia) — a long-term (chronic) form of depression
              </li>
              <li className="Moodli">
              Disruptive mood dysregation disorder — a disorder of chronic,
                severe and persistent irritability in children that often
                includes frequent temper outbursts that are inconsistent with
                the child's developmental age
              </li>

              <li className="Moodli">
              Depression related to
                medical illness — a persistent depressed mood and a significant
                loss of pleasure in most or all activities that's directly
                related to the physical effects of another medical condition
              </li>

              <li className="Moodli">
              Depression induced by substance use or medication ―
                depression symptoms that develop during or soon after substance
            ...
            <div className="moodTextDiv3">
              ...
              <p className="moodText5">
                Talk to a health care professional if you: Feel like your
                ...
                — it may be easier to treat early on.<br></br>If you are
                thinking about ending your life, or having suicidal thoughts due
                to your circumstances and state of mind, chances are you are
                dealing with really painful emotions. Nobody deserves to feel
                that way and we are so sorry you do. Reach out to a therapist
                who can help you work through and process your emotions in a
                healthy way.
              </p>
            </div>
            ...
            <div className="infoCardsMain">
        <div className="infoCardsCard1">
          <div className="infoCardsFront1">
           
            <div className="infoCardsBack1">
              Because you matter, little bee.. even if you don't believe me.
            </div>
          </div>
        </div>
</div>
