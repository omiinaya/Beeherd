    ...
    <div className="MoodPageContainer">
      ...
      <div className="moodTextDiv2">
        ...
        <p className="moodText3">
          ...
          Cyclothymic disorder — a disorder that causes emotional ups and downs
          that are less extreme than bipolar disorder
          <br></br>
          ...
          <br></br>
          Disruptive mood dysregulation disorder — a disorder of chronic, severe
          and persistent irritability in children that often includes frequent
          temper outbursts that are inconsistent with the child's developmental
          age <br></br>Depression related to medical illness — a persistent
          depressed mood and a significant loss of pleasure in most or all
          activities that's directly related to the physical effects of another
          medical condition <br></br>Depression induced by substance use or
      ...
      <div className="moodTextDiv3">
        ...
        <p className="moodText5">
          Talk to a health care professional if you: Feel like your emotions are
          interfering with your work, relationships, social activities or other
          parts of your life Have trouble with drinking or drugs Have suicidal
          thoughts or behaviors — seek emergency treatment immediately Your mood
          disorder is unlikely to simply go away on its own, and it may get
          worse over time. Seek professional help before your mood disorder
          becomes severe — it may be easier to treat early on.<br></br>If you
          are thinking about ending your life, or having suicidal thoughts due
          to your circumstances and state of mind, chances are you are dealing
          with really painful emotions. Nobody deserves to feel that way and we
          are so sorry you do. Reach out to a therapist who can help you work
          through and process your emotions in a healthy way.
        </p>
      </div>
